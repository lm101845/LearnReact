...
import {queryList,addTask,removeTask1,completeTask} from '../api/index'
import {flushSync} from "react-dom";
// 时间格式化的方法
import {useSelector,useDispatch} from 'react-redux'   //不再用connect了
    ...
    const updateHandle = async id=>{
        try{
            ...
            if(+code !== 0){
                ...
                // query()
                dispatch(updateTask(id))  //派发任务，修改redux中的数据
                message.success("恭喜您，操作成功!")
            }
        }catch (_){
